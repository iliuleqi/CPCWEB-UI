function getp4_dzzjc(k,v1,v2)
{
    var dzzjc_xData = k;//["组织一", "组织二", "组织三", "组织四", "组织五", "组织六"],
    var dzzjc_yData1 = v1;//[104, 56, 136, 86, 98, 86],
    var dzzjc_yData2 = v2;//[100, 206, 236, 106, 80, 160],
    var dzzjc_yData = [dzzjc_yData1,dzzjc_yData2];
    dzzjc_borderData = [],
    dzzjc_legend = ["奖励", "惩罚"],
    dzzjc_colorArr = [{
...
//   var fontSize = 20;
var dzzjc_seriesData = [];
var dzzjc_borderHeight = 4;

for(var i=0;i<dzzjc_xData.length;i++){
...
//[dzzjc_yData1, dzzjc_yData2].forEach((item, index) => {
    for(var index=0;index<dzzjc_yData.length;index++){
    var obj1 = {};
    var obj2 = {};
    if (index < 3) {
        obj1 = {
