function getp4_dyjc(k,v1,v2)
{
    var dyjc_xData = k;//["王强", "张峰", "李跃进", "孙丹", "赵瑞", "刘国恩"],
    var dyjc_yData1 = v1;//[104, 56, 136, 86, 98, 86],
    var dyjc_yData2 = v2;//[100, 206, 236, 106, 80, 160],
    var dyjc_yData = [dyjc_yData1];
    dyjc_borderData = [],
    dyjc_legend = ["奖励", "惩罚"],
    dyjc_colorArr = [{
...
for(var i=0;i<dyjc_xData.length;i++){
    dyjc_borderData.push(dyjc_borderHeight);
}
// dyjc_xData.forEach(element => {
//     dyjc_borderData.push(dyjc_borderHeight);
// });
//[dyjc_yData1].forEach((item, index) => {
    for(var index=0;index<dyjc_yData.length;index++){
    var obj1 = {};
    var obj2 = {};
    if (index < 3) {
        obj1 = {
