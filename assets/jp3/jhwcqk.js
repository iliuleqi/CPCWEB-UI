function getP3_jhwcqk(ks,vs1,vs2)
{
    var jhwcqk_xData = ks,//["计划一", "计划二", "计划三", "计划四", "计划五", "计划六"],
    jhwcqk_yData1 = vs1,//[104, 56, 136, 86, 98, 86],
    jhwcqk_yData2 = vs2,//[100, 206, 236, 106, 80, 160],
    jhwcqk_borderData = [],
    jhwcqk_legend = ["已安排", "未安排"],
    jhwcqk_colorArr = [{
