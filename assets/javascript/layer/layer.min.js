...
function(a, b) {
    ...
    g.pt.vessel = function(a, b) {
        ...
        l = f.hiddenMinIcon && (1 === f.type || 2 === f.type),
        ...
        function() {
            var text = !l ? '<a class="layui-layer-min" href="javascript:;"><cite></cite></a>' : '';
            var a = j ? text + '<a class="layui-layer-ico layui-layer-max" title="最大化" href="javascript:;"></a>': "";
            return f.closeBtn && (a += '<a title="关闭" class="layui-layer-ico ' + h[7] + " " + h[7] + (f.title ? f.closeBtn: 4 == f.type ? "1": "2") + '" href="javascript:;"></a>'),
            a
        } () + "</span>" + (f.btn ?
        function() {
            var a = "";
    ...
    e.record = function(a) {
        ...
        a.find(".layui-layer-max").addClass("layui-layer-maxmin").attr("title", "还原"),
        a.attr({
            area: b
        })
    },
    ...
    f.restore = function(a) {
        ...
        b.find(".layui-layer-max").removeClass("layui-layer-maxmin").attr("title", "最大化"),
